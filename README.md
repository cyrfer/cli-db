...
cli-db/0.3.7 darwin-x64 node-v12.3.1
$ cli-db --help [COMMAND]
USAGE
  $ cli-db COMMAND
...
...
_See code: [src/commands/ffprobe.js](https://github.com/cyrfer/cli-db/blob/v0.3.7/src/commands/ffprobe.js)_
...
_See code: [src/commands/mongo.js](https://github.com/cyrfer/cli-db/blob/v0.3.7/src/commands/mongo.js)_
<!-- commandsstop -->
